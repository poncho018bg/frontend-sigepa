...
export const ExpedienteDocumentos = (props) => {
    ...
    const { idPrograma } = '';
    const { identPrograma } = '';
    const { setValidarDocs, validarDocs} = props;
    ...
    const [activar, setActivar] = React.useState("");
        ...
        <GridItem xs={12} sm={12} md={12}>
            <Card>
                <CardHeader color="primary">
                    <h4 className={classes.cardTitleWhite}>Documentos integrados en el expediente</h4>
                </CardHeader>
                <CardBody>
                    {(documentosApoyoList
                    ).map((row, i) => {
