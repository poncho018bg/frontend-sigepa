...
var _EventEmitter = _interopRequireDefault(require("formiojs/EventEmitter"));
...
var _NestedDataComponent2 = _interopRequireDefault(require("formiojs/components/_classes/nesteddata/NestedDataComponent"));

var _utils = require("formiojs/utils/utils");

var _formUtils = require("formiojs/utils/formUtils");
...
var Webform = /*#__PURE__*/function (_NestedDataComponent) {
  ...
  function Webform() {
    ...
    if (_this2.options.saveDraft && _Formio.GlobalFormio.events) {
      _Formio.GlobalFormio.events.on('formio.user', function (user) {
