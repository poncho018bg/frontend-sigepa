...
export const RolesScreen = () => {
  ...
  const { getSubmodulosByperfil, submodulosPerfilList } = useContext(
    SubmodulosByPerfilContex
  );
        ...
        <Collapse in={open} timeout="auto" unmountOnExit>
          <List component="div" disablePadding style={{ left: `5em` }}>
            <ListItem
              ...
              dense
              button
              onClick={handleToggleSub(indxS, sub)}
            >
              <ListItemIcon>
                <Checkbox
                  edge="start"
  ...
  const handleToggleSub = (value, id) => () => {
    ...
    if (currentIndex === -1) {
      ...
      modules.splice(modules.indexOf(idMod), 1);
    }
                ...
                <GridItem xs={12} sm={12} md={12}>
                  <DialogContent>
                    ...
                    {errors.idPerfil && (
                      <FormHelperText
                        error={
                          errors.idPerfil !== null &&
                          errors.idPerfil !== undefined
                        }
                      >
                        {errors.idPerfil}
                      </FormHelperText>
