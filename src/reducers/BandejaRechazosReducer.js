...
export default (state, action) => {
    ...
    switch (action.type) {
        ...
        case MODIFICAR_BANDEJA_RECHAZOS:
            return {
                ...state,
                bandejaRechazosList: state.bandejaRechazosList.map(
                    bandejaRechazos => bandejaRechazos.id === action.payload.id ? action.payload : bandejaRechazos
                )
            };
        case ELIMINAR_BANDEJA_RECHAZOS:
            return {
                ...state,
                bandejaRechazosList: state.bandejaRechazosList.filter(bandejaRechazos => bandejaRechazos.id !== action.payload)
            };
        case CAMBIAR_PAGINA:
            return {
                ...state,
